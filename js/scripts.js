...
const header=document.getElementById("saludoHeader");
...
function renderCourse() {
    ...
    cursos.forEach(curso => {
        ...
        <div class="card mb-3 col-md-5" >
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="${curso.img}" class="img-fluid m-auto rounded-md-start row" alt="${curso.img}">
                    </div>
                <div class="col-md-8">
                <div class="card-body">
                    <h5 class="card-title text-center">${curso.title}</h5>                    
                </div>
                <div class="card-footer p-2 pt-0 border-top-0 bg-transparent">
                    <div class="text-center"><a class="btnCurso btn btn-outline-light mt-auto" href="#${curso.id}">Información</a></div>
                </div>
            </div>
